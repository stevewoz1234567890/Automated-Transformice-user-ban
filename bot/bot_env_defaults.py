...
DEFAULT_PROCESS_ENV: dict[str, str] = {
    ...
    "BOT_POST_LOGIN_ACTIONSCRIPT_SWEEP_DELAY_SEC": "0.55",
    "BOT_POST_LOGIN_ACTIONSCRIPT_SWEEP_LEAD_SEC": "1.5",
    ...
    "BOT_FLASH_LOADER_EARLY_RETRY_INTERVAL_SEC": "3.0",
