...
def load_bot_config() -> SimpleNamespace:
    ...
    return SimpleNamespace(
        ...
        UPSTREAM_MAX_CONCURRENT_CONNECTS=_int_ge_zero("BOT_UPSTREAM_MAX_CONCURRENT_CONNECTS", 2),
        UPSTREAM_OPEN_CONNECTION_TIMEOUT_SEC=_float("BOT_UPSTREAM_OPEN_CONNECTION_TIMEOUT_SEC", 12.0),
        ...
        UPSTREAM_PROBE_TIMEOUT_SEC=_float("BOT_UPSTREAM_PROBE_TIMEOUT_SEC", 10.0),
        UPSTREAM_PROBE_RETRIES=_int_ge_zero("BOT_UPSTREAM_PROBE_RETRIES", 2),
        UPSTREAM_PROBE_RETRY_PAUSE_SEC=_float("BOT_UPSTREAM_PROBE_RETRY_PAUSE_SEC", 3.0),
        UPSTREAM_PROBE_FINAL_LONG_TIMEOUT=_truthy(
            "BOT_UPSTREAM_PROBE_FINAL_LONG_TIMEOUT", True
        ),
        UPSTREAM_PROBE_FINAL_TIMEOUT_CAP_SEC=_float(
            "BOT_UPSTREAM_PROBE_FINAL_TIMEOUT_CAP_SEC", 35.0
        ),
        UPSTREAM_PROBE_FINAL_TIMEOUT_FLOOR_SEC=_float(
            "BOT_UPSTREAM_PROBE_FINAL_TIMEOUT_FLOOR_SEC", 20.0
        ),
        ...
        HEADLESS_PARALLEL_RETRY_FAILED_SLOTS=_truthy(
            "BOT_HEADLESS_PARALLEL_RETRY_FAILED_SLOTS", True
        ),
        HEADLESS_PARALLEL_RETRY_AFTER_SEC=_float(
            "BOT_HEADLESS_PARALLEL_RETRY_AFTER_SEC", 90.0
        ),
        HEADLESS_PARALLEL_RETRY_STAGGER_SEC=_float(
            "BOT_HEADLESS_PARALLEL_RETRY_STAGGER_SEC", 5.0
        ),
        ...
        HEADLESS_SEQUENTIAL_EARLY_EXIT_ON_WIN121=_truthy(
            "BOT_HEADLESS_SEQUENTIAL_EARLY_EXIT_ON_WIN121", True
        ),
